-- =============================================================================
-- MaBarak — schema de reference SQLite
-- =============================================================================
--
...
-- `backend/src/mabarak_api/schema.sql`, qui doit rester identique a ce fichier.
--
-- Conventions :
...
--
-- Verification rapide :
--   sqlite3 /tmp/mabarak_check.db < docs/schema.sql
-- =============================================================================
...
CREATE TABLE ha_link (
    ...
    -- Qualifie l'usage MaBarak de cette cible, independamment du domain HA.
