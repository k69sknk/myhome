...
type MaBarakConfigEntry = ConfigEntry[MaBarakCoordinator]


class MaBarakCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    config_entry: MaBarakConfigEntry
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        try:
            ...
            raise UpdateFailed(f"Add-on MaBarak injoignable : {err}") from err
        ...
        if version != SUPPORTED_API_SCHEMA_VERSION:
            ...
            raise ConfigEntryError(
                f"Version de l'add-on MaBarak incompatible : contrat v{version} recu, "
